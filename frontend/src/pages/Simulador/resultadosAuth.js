...
import styles from './resultadosAuth.module.css'
...
function ResultadosAuth(){
    ...
    let { nombre, value, numQuotas, tarjeta } = datos
    let tarjetaReal = JSON.parse(tarjeta)
    console.log(tarjetaReal)
    let interestRate = tarjetaReal.tasaInteres
